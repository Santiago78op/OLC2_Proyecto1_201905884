...
// EnterAugmentedAssignmentDecl is called when production AugmentedAssignmentDecl is entered.
func (s *BaseVLangGrammarListener) EnterAugmentedAssignmentDecl(ctx *AugmentedAssignmentDeclContext) {
}

// ExitAugmentedAssignmentDecl is called when production AugmentedAssignmentDecl is exited.
func (s *BaseVLangGrammarListener) ExitAugmentedAssignmentDecl(ctx *AugmentedAssignmentDeclContext) {}
